...
class WP_Resume_Manager_Form_Submit_Resume extends WP_Job_Manager_Form {
		...
		$this->fields = apply_filters( 'submit_resume_form_fields', array(
			'resume_fields' => array(
				...
				'candidate_location' => array(
					'label'       => __( 'Current Address', 'wp-job-manager-resumes' ),
					'type'        => 'text',
					'required'    => true,
					'placeholder' => __( 'e.g. "Mumbai, Maharashtra" "Surat, Gujrat"', 'wp-job-manager-resumes' ),
					'priority'    => 4
				),
				'candidate_permanent_location' => array(
					'label'       => __( 'Permanent address', 'wp-job-manager-resumes' ),
					'type'        => 'text',
					'required'    => true,
					'placeholder' => __( 'e.g. "Mumbai, Maharashtra" "Surat, Gujrat"', 'wp-job-manager-resumes' ),
					'priority'    => 5
				...
				'candidate_gender' => array(
					'label' => __( 'Gender', 'job_manager_gender' ),
           				 'type' => 'text',
            				 'required' => true,
            				 'placeholder' => __( 'Male / Female', 'wp-job-manager-resumes' ),
					 'priority' => 6,
				),
				'candidate_dob' => array('label' => __( 'Date of Birth', 'job_manager_dob' ),
            				'type' => 'text',
            				'required' => true,
				...
				'candidate_photo' => array(
					'label'       => __( 'Passport Size Photo', 'wp-job-manager-resumes' ),
					'type'        => 'file',
					'required'    => false,
					'placeholder' => '',
					'priority'    => 8,
				...
				'resume_content' => array(
					...
					'type'        => 'wp-editor',
					'required'    => false,
					'placeholder' => 'You can Copy-Paste your resume here.',
					'priority'    => 9
				),
				'resume_skills' => array(
	...
	public function preview() {
		...
		if ( $this->resume_id ) {
			...
			setup_postdata( $post );
			?>
			<form method="post" id="resume_preview" style="margin-top: 45px;">
				<div class="resume_preview_title">
					...
					<input style="float: right;" type="submit" name="continue" id="resume_preview_submit_button" class="button" value="<?php echo apply_filters( 'submit_resume_step_preview_submit_text', __( 'Submit Resume &rarr;', 'wp-job-manager-resumes' ) ); ?>" />
				...
				<div class="resume_preview single-resume" style="    border: 1px solid #14b1bb;margin-top: 20px;padding: 20px;">
					<h1 style="text-align: center;padding-bottom: 5px;margin: 1px 0px 0px 0px;"><?php the_title(); ?></h1>
