		...
		IN.API.Profile("me")
			...
			.result( function( result ) {
				...
				if ( profile.pictureUrl ) {
					...
					$('.fieldset-candidate_photo .field').prepend('<div class="job-manager-uploaded-files"><div class="job-manager-uploaded-file"><span class="job-manager-uploaded-file-preview"><img width="220" height="180" src="' + profile.pictureUrl + '" /> <a class="job-manager-remove-uploaded-file" href="#">[' + resume_manager_resume_submission.i18n_remove + ']</a></span><input type="hidden" class="input-text" name="current_' + photo_field_name + '" value="' + profile.pictureUrl + '" /></div></div>');
				}
