		...
		$this->fields = apply_filters( 'submit_job_form_fields', array(
			...
			'company' => array(
				...
				'contact_number' => array(
                                        'label'       => __( 'Contact Number', 'wp-job-manager' ),
                                        'type'        => 'text',
                                        'required'    => true,
                                        'placeholder' => __( 'Contact Person number', 'wp-job-manager' ),
                                        'priority'    => 5
                                ),
/*
				'company_video' => array(
...
*/
				'contact_person' => array(
					'label'       => __( 'Contact Person', 'wp-job-manager' ),
                                        'type'        => 'text',
                                        'required'    => true,
                                        'placeholder' => __( 'Name with Designation (ex: Surbhi - HR Manager)', 'wp-job-manager' ),
                                        'priority'    => 4
				),
/*
...
*/
	...
	protected function update_job_data( $values ) {
		...
		if ( is_user_logged_in() ) {
			...
			update_user_meta( get_current_user_id(), '_contact_person', isset( $values['company']['contact_person'] ) ? $values['company']['contact_person'] : '' );
			update_user_meta( get_current_user_id(), '_contact_num', isset( $values['company']['contact_number'] ) ? $values['company']['contact_number'] : '' );
		}
