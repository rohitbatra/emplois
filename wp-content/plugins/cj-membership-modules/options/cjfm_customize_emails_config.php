...
$cjfm_item_options['cjfm_customize_emails_config'] = array(
	...
	array(
		'type' => 'sub-heading',
		'id' => 'incoming_email_html_heading',
		'label' => '',
		'info' => '',
		'suffix' => '',
		'prefix' => '',
		'default' => __('HTML Template', 'cjfm'),
		'options' => '', // array in case of dropdown, checkbox and radio buttons
	),
	array(
		'type' => 'textarea',
		'id' => 'outgoing_email_content_above',
		'label' => __('HTML Above Message', 'cjfm'),
		'info' => __('This HTML will be included above email messsage.', 'cjfm'),
		'suffix' => '',
		'prefix' => '',
		'default' => '',
		'options' => '', // array in case of dropdown, checkbox and radio buttons
	...
	array(
		'type' => 'textarea',
		'id' => 'outgoing_email_content_below',
		'label' => __('HTML Below Message', 'cjfm'),
		'info' => __('This HTML will be included below email messsage.', 'cjfm'),
		'suffix' => '',
		'prefix' => '',
		'default' => '',
		'options' => '', // array in case of dropdown, checkbox and radio buttons
