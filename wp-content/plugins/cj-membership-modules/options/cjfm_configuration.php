...
$avatar_array = array(
	'gravatar' => __('Use Gravatar', 'cjfm'),
	'custom' => __('Allow custom profile picture upload', 'cjfm'),
	'social' => __('Use Social Profile Avatar', 'cjfm'),
);
...
$cjfm_item_options['cjfm_configuration'] = array(
	...
	array(
		...
		'prefix' => '',
		'default' => 'gravatar',
		'options' => $avatar_array, // array in case of dropdown, checkbox and radio buttons
	),
	array(
		'type' => 'text',
