...
if($_GET['self_approved']){
  ...
  $destination_number = $mydata['phone_no'][0];
      ...
      // Set the job applied status as confirmed. in applied_job_details.



      echo $qur = "UPDATE applied_job_details SET

              approved_by_candidate = 1
      ...
      echo '<div style="background-color: #469A2A;
        ...
        width: 50%;">Approved, Message has been sent.</div>';
            ...
            echo 'You have not applied for any jobs.';
