...
function jobseek_register_plugins() {
    ...
    $plugins = array(
        ...
        array(
            'name'               => 'CSSJockey Membership Modules', // The plugin name
            'slug'               => 'cj-membership-modules',
            'source'             => get_template_directory() . '/plugins/cj-membership-modules.zip', // The plugin source
